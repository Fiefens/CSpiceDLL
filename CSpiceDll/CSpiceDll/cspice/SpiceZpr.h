...
*/
   ...
   DLL_EXPORT void furnsh_c(ConstSpiceChar* file);
  ...
  void               hrmint_c ( SpiceInt            n,
   ...
   DLL_EXPORT   void              reclat_c ( ConstSpiceDouble    rectan[3],
                                SpiceDouble       * radius,
                                SpiceDouble       * longitude,
                                SpiceDouble       * latitude  );
   ...
   DLL_EXPORT void              spkezr_c ( ConstSpiceChar    * target,
                                SpiceDouble         epoch,
                                ConstSpiceChar    * frame,
                                ConstSpiceChar    * abcorr,
                                ConstSpiceChar    * observer,
   ...
   DLL_EXPORT void              str2et_c ( ConstSpiceChar    * date,
                                SpiceDouble       * et   );
