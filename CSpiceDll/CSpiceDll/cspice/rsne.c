...
#endif
{
	...
	for (x = &nl_cache; (y = *x) != NULL; x0 = x, x = &y->next) {
		if (nl == y->nl) {
			return y;
		}
	}
...
#endif
{
	int ch = 0, got1 = 0, k = 0, n = 0, nd = 0, quote = 0, readall = 0;
	Namelist* nl = NULL;
	static char where[] = "namelist read";
	char buf[64] = { 0 };
	hashtab* ht = NULL;
	Vardesc* v = NULL;
	dimen* dn = NULL, * dn0 = NULL, * dn1 = NULL;
	ftnlen* dims = NULL, * dims1 = NULL;
	ftnlen b = 0, b0 = 0, b1 = 0, ex = 0, no = 0, no1 = 0, nomax = 0, size = 0, span = 0;
	ftnint type = 0;
	char* vaddr = NULL;
	long iva = 0, ivae = 0;
	dimen dimens[MAXDIM] = { 0 }, substr = { 0 };
